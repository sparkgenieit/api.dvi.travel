...
console.log('\n=== TESTING OTA_HotelResNotifRQ WITH RESAVENUE API ===\n');
...
// Test 1: PropertyDetails (OTA_HotelDetailsRQ)
console.log('═'.repeat(70));
console.log('TEST 1: OTA_HotelDetailsRQ - Get Property Details');
console.log('═'.repeat(70));
...
console.log('\n📤 Sending PropertyDetails Request...');
...
const propertyReq = http.request(propertyOptions, (res) => {
  ...
  res.on('end', () => {
    ...
    // Test 2: Booking Confirmation (OTA_HotelResNotifRQ)
    console.log('\n' + '═'.repeat(70));
    console.log('TEST 2: OTA_HotelResNotifRQ - Booking Confirmation');
    console.log('═'.repeat(70));
    ...
    const bookingReq = http.request(bookingOptions, (res) => {
      ...
      res.on('end', () => {
        ...
        // Test 3: Cancellation (OTA_HotelResNotifRQ)
        console.log('\n' + '═'.repeat(70));
